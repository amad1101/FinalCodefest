<template>
  <div class="simulation">
    ...
    <!-- <h2> Try out Alpha Trail at: <a v-bind:href="'http://alphatrail.me'" target='_blank' rel = 'noopener'>alphatrail.me</a> </h2> -->
